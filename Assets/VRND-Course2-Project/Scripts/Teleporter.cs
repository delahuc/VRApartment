...
public class Teleporter : MonoBehaviour {
	...
	Animator globeAnimator;
	Animator bookShelfAnimator;
    ...
    void Start() {
		...
		GameObject globeObject = GameObject.Find("GlobeHolder/SphereHolder/Sphere");
		globeAnimator = globeObject.GetComponent<Animator>();
		GameObject bookShelfObject = GameObject.Find("SecretBookShelf");
		bookShelfAnimator = bookShelfObject.GetComponent<Animator>();
    }
